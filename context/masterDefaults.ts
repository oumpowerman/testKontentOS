export const DEFAULT_OPTIONS = [
    ...
    { type: 'WORK_CONFIG', key: 'DAILY_SUMMARY_TIME', label: '18:00', color: '', sort_order: 7 },
    ...
    { type: 'WORK_CONFIG', key: 'LATE_MODE_DYNAMIC', label: '0', color: '', sort_order: 12, description: '0 (Flat Rate): หักคะแนนคงที่ตามกฎ LATE, 1 (Dynamic Rate): หักคะแนนเพิ่มตามนาทีที่สายจริง' },
    ...
    { type: 'WORK_CONFIG', key: 'ENABLE_FOUR_STAGE_LATE', label: 'true', color: '', sort_order: 151, description: 'เปิดใช้งานกฎการเข้าสายแบบ 4 ระดับ' },
    { type: 'WORK_CONFIG', key: 'LATE_STAGE1_MAX', label: '5', color: '', sort_order: 152, description: 'เวลาสูงสุดของระดับที่ 1 (นาที)' },
    { type: 'WORK_CONFIG', key: 'LATE_STAGE2_MAX', label: '30', color: '', sort_order: 153, description: 'เวลาสูงสุดของระดับที่ 2 (นาที)' },
    { type: 'WORK_CONFIG', key: 'LATE_STAGE3_MAX', label: '60', color: '', sort_order: 154, description: 'เวลาสูงสุดของระดับที่ 3 (นาที)' },
    { type: 'WORK_CONFIG', key: 'LATE_STAGE4_BASE_HP', label: '300', color: '', sort_order: 155, description: 'ค่าปรับตั้งต้นของระดับที่ 4 (HP)' },
    { type: 'WORK_CONFIG', key: 'LATE_HP_PER_MINUTE', label: '1', color: '', sort_order: 156, description: 'อัตราการหักคะแนน HP ต่อนาที' },
    ...
    { type: 'LEAVE_TYPE', key: 'ONSITE', label: 'ปฏิบัติงานนอกสถานที่', color: 'bg-orange-500', sort_order: 6, description: '{"icon": "MapPin", "category": "SPECIAL", "subLabel": "ขออนุญาตปฏิบัติงานนอกสถานที่ / ออกกอง", "defaultQuota": 999, "placeholder": "เช่น ออกกองถ่ายโฆษณาที่สตูดิโอ...", "reasonLabel": "รายละเอียดสถานที่และงานที่ทำ"}' },
