...
const LeaveQuotaWidget: React.FC<LeaveQuotaWidgetProps> = ({ leaveUsage, onHistoryClick }) => {
    ...
    return (
        <div className="bg-white rounded-[2rem] sm:rounded-[3rem] border-4 border-[#F8F9FA] shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-5 sm:p-8 relative overflow-hidden group h-full flex flex-col justify-between">
                        ...
                        >
                            <div className="flex justify-between items-end mb-2 sm:mb-3 px-1">
                                <div className="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <div>
                                        <span className="text-xs sm:text-sm font-bold text-slate-700 block leading-none">{option.label}</span>
                                        <span className={`text-[9px] sm:text-[10px] font-bold ${theme.accent} uppercase tracking-widest`}>{type}</span>
                                    </div>
                                </div>
                            ...
                            <div className="h-4 sm:h-5 w-full bg-slate-100 rounded-full p-1 border border-slate-200/50 shadow-inner relative group/bar overflow-hidden">
