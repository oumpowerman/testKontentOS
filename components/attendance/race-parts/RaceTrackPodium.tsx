...
export const RaceTrackPodium: React.FC<RaceTrackPodiumProps> = ({ checkedInRacers, allRacersCount }) => {
    ...
    return (
        <div className="h-full min-h-[230px] flex flex-col border-2 border-slate-900 bg-white p-3.5 rounded-2xl shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] font-sans">
            {/* Panel Header */}
