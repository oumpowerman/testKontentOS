        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-[2.5rem] border border-gray-100 overflow-hidden shadow-sm">
                <div className="px-6 py-5 bg-gray-50/50 border-b border-gray-100 flex items-center gap-3">
                    ...
                    <h3 className="font-black text-gray-800 uppercase tracking-widest text-sm">Breakdown by Pillar</h3>
                </div>
                <div className="p-2">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {pillarCounts.map(item => (
                                <tr key={item.key} className="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td className="px-4 py-3 text-sm font-black text-gray-800 text-right">{item.count}</td>
            ...
            <div className="bg-white rounded-[2.5rem] border border-gray-100 overflow-hidden shadow-sm">
                <div className="px-6 py-5 bg-gray-50/50 border-b border-gray-100 flex items-center gap-3">
                    ...
                    <h3 className="font-black text-gray-800 uppercase tracking-widest text-sm">Breakdown by Category</h3>
                </div>
                <div className="p-2">
                    <table className="w-full text-left">
                        <thead>
