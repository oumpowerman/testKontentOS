                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {assets.length === 0 ? (
                                    <div className="col-span-full py-20 text-center bg-white rounded-[2rem] border-4 border-dashed border-slate-100 text-slate-300">
                                        ...
                                        <p className="font-black uppercase tracking-widest text-sm">ยังไม่มีไฟล์แนบ</p>
                                    </div>
                                ) : (
                                    assets.map(asset => {
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div className="min-w-0">
                                                        <h4 className="font-black text-slate-800 truncate">{asset.name || 'Untitled Link'}</h4>
                                                        <div className="flex items-center gap-1.5 mt-1">
                                                            {isDrive && <span className="text-[8px] font-black bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded uppercase tracking-wider">Google Drive</span>}
