...
import { Paperclip, Plus, Link as LinkIcon, File, Sparkles, ListChecks, HardDrive, Loader2 } from 'lucide-react';
                ...
                {meeting.isPartial ? (
                    <div className="flex-1 flex flex-col items-center justify-center space-y-4 animate-pulse">
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 blur-xl bg-indigo-400/20 rounded-full" />
                        </div>
                        <p className="text-sm font-black text-indigo-400 uppercase tracking-widest">กำลังดึงข้อมูลเนื้อหาทีมประชุม...</p>
                        <div className="w-32 h-1.5 bg-indigo-50 rounded-full overflow-hidden">
                            <div className="h-full bg-indigo-400 animate-[shimmer_1.5s_infinite] w-full" />
                        </div>
                    </div>
                ) : (
                    <>
