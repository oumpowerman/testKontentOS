export const BRAND_CONFIG = {
 ...
 // ---------------------------------------------------------------------------
  // [DEPRECATED] ย้ายระบบการคำนวณและเกณฑ์กฎเข้าสายแบบ 4 ระดับ ไปใช้ในฐานข้อมูล (ตาราง master_options) แบบ Real-time เรียบร้อยแล้ว
  // โค้ดทั้งหมดจะไปดึงค่าตัวแปรผ่านระบบ DB (ประเภท WORK_CONFIG) เพื่อความยืดหยุ่นในการแก้ไขผ่านหน้าจอ Admin
  // ---------------------------------------------------------------------------
